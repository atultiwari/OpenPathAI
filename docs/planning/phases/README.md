...
| | |
|---|---|
| Active phase | **Phase 22+ — conditional / deferred** (Phase 21.7 closed 2026-04-26 — Quickstart wizard now actually fits on local datasets, polls run status, surfaces real paths). |
| Latest Git tag | `phase-21.7-complete` |
