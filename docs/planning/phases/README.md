...
| | |
|---|---|
| Active phase | **Phase 14 — Detection & Segmentation** (pending spec; Phase 13 closed 2026-04-24) |
| Latest Git tag | `phase-13-complete` (pushed to `origin`) |
| Latest released version | v0.1.0 feature set landed (Phase 6 close); v0.2.0 feature set complete (Phase 7 ✅, Phase 8 ✅); v0.5.0 feature set fully landed (Phase 9 ✅, Phase 10 ✅, Phase 11 ✅, Phase 12 ✅ — Bet 1 opened); v1.0.0 line advancing (Phase 13 ✅ foundation + MIL). |
