...
export function AnalyseScreen() {
  ...
  return (
    <section className="task-content">
      ...
      <StorageBanner paths={["audit_db", "cache"]} />
      <button
        type="button"
        className="tab-guide-pill"
        onClick={() => navigateToTab("quickstart")}
        aria-label="Open the Quickstart wizard"
      >
        <span aria-hidden>🚀</span>
        <span>First time? Open the Quickstart wizard →</span>
      </button>
      <h2>Analyse</h2>
      <p className="lede">
